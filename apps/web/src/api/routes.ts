export const routes = {
  ...
  users: {
    ...
    addAddress: '/users/me/addresses',
    getAddresses: '/users/me/addresses',
    updateAddress: (addressId: string | number) => `/users/me/addresses/${addressId}`,
    deleteAddress: (addressId: string | number) => `/users/me/addresses/${addressId}`,
    deactivateAccount: '/users/me/deactivate-account',
