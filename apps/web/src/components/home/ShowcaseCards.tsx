...
import type { ShowcaseCardConfig } from '../../config/siteConfig'
...
type ShowcaseCardsProps = {
  cards: ShowcaseCardConfig[]
}

export default function ShowcaseCards({ cards }: ShowcaseCardsProps) {
  return (
    <div
