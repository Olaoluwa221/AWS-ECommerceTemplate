      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-8 w-full max-w-md shadow-sm">
        ...
        {sent ? (
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold mb-2" style={{ color: 'var(--brand-primary)' }}>Check your email</h2>
            <p className="text-gray-500 mb-6">
              If an account exists for <strong>{email}</strong>, we've sent a password reset link. Check your inbox.
            </p>
            <Link to="/login" className="text-sm font-medium hover:opacity-80 transition-opacity" style={{ color: 'var(--brand-accent)' }}>
              Back to login
            </Link>
          </div>
        ) : (
          <>
            <h1 className="text-2xl font-bold mb-2" style={{ color: 'var(--brand-primary)' }}>Forgot password</h1>
            ...
            <p className="text-center text-sm text-gray-400 mt-6">
              ...
              <Link to="/login" className="font-medium hover:opacity-80 transition-opacity" style={{ color: 'var(--brand-accent)' }}>
                Sign in
              </Link>
            </p>
          </>
