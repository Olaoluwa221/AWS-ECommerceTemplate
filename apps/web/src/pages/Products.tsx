...
export default function Products() {
  ...
  const getStartingPrice = (variants?: ProductVariant[]): number | null => {
    if (!variants || variants.length === 0) return null
    return Math.min(...variants.map((v: ProductVariant) => v.price))
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Header */}
      <section style={{ backgroundColor: 'var(--brand-primary)' }} className="px-6 py-14 text-center">
        <h1 className="text-4xl font-bold text-white mb-3">Our Products</h1>
        <p className="text-blue-200 text-lg mb-8">Browse our full catalog</p>
        ...
        <div className="flex gap-3 flex-wrap mb-10">
          {['All', ...productTypes.map(t => t.typeName)].map(cat => (
            <button
              ...
              style={activeCategory === cat ? { backgroundColor: 'var(--brand-accent)' } : {}}
            >
              {cat}
            </button>
          ))}
            ...
            : filtered.length === 0
              ? (
                <div className="col-span-full text-center py-20">
                  ...
                  <h3 className="text-xl font-semibold mb-2" style={{ color: 'var(--brand-primary)' }}>No products found</h3>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <h3 className="text-base font-semibold mt-2 mb-1 group-hover:text-orange-500 transition-colors" style={{ color: 'var(--brand-primary)' }}>
                        {product.productName}
                      </h3>
                      {product.description && (
