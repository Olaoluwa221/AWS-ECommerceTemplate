  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const responseData = err && typeof err === 'object' && 'response' in err
        ? ((err as { response?: { data?: unknown } }).response?.data ?? 'Registration failed. Please try again.')
        : 'Registration failed. Please try again.'
      setError(typeof responseData === 'string' ? responseData : 'Registration failed. Please try again.')
    } finally {
      setLoading(false)
    }
  }
