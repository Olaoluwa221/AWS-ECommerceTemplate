  ...
  if (!token) return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl border border-gray-200 p-8 w-full max-w-md text-center">
        ...
        <h2 className="text-2xl font-bold mb-2" style={{ color: 'var(--brand-primary)' }}>Invalid link</h2>
        <p className="text-gray-500 mb-6">This reset link is invalid or has expired.</p>
        <Link to="/forgot-password" style={{ color: 'var(--brand-accent)' }} className="text-sm font-medium hover:opacity-80">
          Request a new link
        </Link>
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl border border-gray-200 p-8 w-full max-w-md shadow-sm">
        <h1 className="text-2xl font-bold mb-2" style={{ color: 'var(--brand-primary)' }}>Reset password</h1>
